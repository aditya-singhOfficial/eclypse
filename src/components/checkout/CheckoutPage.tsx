    ...
    if (data.paymentMethod === "card") {
      ...
      setTimeout(async () => {
        ...
        const orderId = await addOrder({
          ...
          subtotal: order.itemPrice, // Assuming itemPrice is subtotal
          shipping: order.shipping,
          tax: order.tax,
          total: order.total,
          shippingAddress: shippingAddress!,
          payment: payment,
          // trackingId will be generated by addOrder
        });
        const newOrderId = typeof orderId === 'string' ? orderId : (orderId as Order).id;
                ...
                <div className="mb-6">
                  ...
                  {shippingAddress && (
                    <div className="p-4 bg-black border border-gray-800 rounded">
                      ...
                      <p className="text-gray-300">{shippingAddress.city}, {shippingAddress.state} {shippingAddress.postalCode}</p>
